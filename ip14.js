...
const allHoverImages2 = document.querySelectorAll('.hover-container div img');
const imgContainer2 = document.querySelector('.img-container2');

window.addEventListener('DOMContentLoaded', () => {
  allHoverImages2[0].parentElement.classList.add('active');
});

allHoverImages2.forEach((image) => {
  image.parentElement.addEventListener('click', () =>{
    imgContainer2.querySelector('img').src = image.src;
    resetActiveImg();
