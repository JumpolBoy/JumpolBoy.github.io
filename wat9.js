...
const allHoverImages3 = document.querySelectorAll('.hover-container div img');
const imgContainer3 = document.querySelector('.img-container3');

window.addEventListener('DOMContentLoaded', () => {
  allHoverImages3[0].parentElement.classList.add('active');
});

allHoverImages3.forEach((image) => {
  image.parentElement.addEventListener('click', () =>{
    imgContainer3.querySelector('img').src = image.src;
    resetActiveImg();
