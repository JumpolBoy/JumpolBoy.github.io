...
const allHoverImages1 = document.querySelectorAll('.hover-container div img');
const imgContainer1 = document.querySelector('.img-container1');

window.addEventListener('DOMContentLoaded', () => {
  allHoverImages1[0].parentElement.classList.add('active');
});

allHoverImages1.forEach((image) => {
